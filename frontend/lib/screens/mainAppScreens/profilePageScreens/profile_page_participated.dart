...
import 'package:opinion_frontend/services/getParticipatedPosts.dart';
import 'package:jiffy/jiffy.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:opinion_frontend/providers.dart';

class ProfilePageParticipated extends StatefulWidget {
  @override
  _ProfilePageParticipatedState createState() =>
      _ProfilePageParticipatedState();
}

class _ProfilePageParticipatedState extends State<ProfilePageParticipated> {
  ...
  Future<void> _fetchPage(int pageKey) async {
    try {
      final response = await getParticipatedPosts(
